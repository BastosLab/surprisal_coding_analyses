function [stim_muae_zs, predictors] = glm_features(nwb, baseline, offset, stim_probs, p)
%GLM_FEATURES
...
[muae_zs, times_in_trial, stims_in_trial] = passiveglo_muae(nwb, trials, stims, baseline, p);
